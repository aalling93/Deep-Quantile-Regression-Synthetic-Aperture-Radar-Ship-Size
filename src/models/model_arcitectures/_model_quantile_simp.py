...
class quantile_model:
    ...
    def make_model(
        ...
        pred1 = tf.keras.layers.Dense(5)(model1)
        pred1 = tf.keras.layers.LeakyReLU(alpha)(pred1)
        pred2 = tf.keras.layers.Dense(5)(model1)
        pred2 = tf.keras.layers.LeakyReLU(alpha)(pred2)
        pred3 = tf.keras.layers.Dense(5)(model1)
        ...
        pred1 = tf.keras.layers.Dense(5,activation='relu')(pred1)
        #pred1 = tf.keras.layers.Relu(alpha,name='length')(pred1)
        pred2 = tf.keras.layers.Dense(5,activation='relu')(pred2)
        #pred2 = tf.keras.layers.Relu(alpha,name='width')(pred2)
        pred3 = tf.keras.layers.Dense(5,activation='relu')(pred3)
        #pred3 = tf.keras.layers.Relu(alpha,name='ratio')(pred3)
